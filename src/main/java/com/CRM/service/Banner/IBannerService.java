...
public interface IBannerService {
        ...
        APIResponse<Boolean> updateBanner(UUID id, bannerRequest bannerRequest, MultipartFile media, int width,
                        int height)
                        throws NotFoundException;

        APIResponse<Boolean> deleteBanner(UUID id) throws NotFoundException;
